...
static uint8_t scanRspData[] =
{
  ...
  0x11,
    GAP_ADTYPE_LOCAL_NAME_COMPLETE,
    'r','e','t','r','o','t','o','p','e','-',
    'm','o','t','(','L',')',     // make this (R) or (L)  HJS (3 places)
...
// GAP GATT Attributes
static const uint8_t attDeviceName[GAP_DEVICE_NAME_LEN] = "SensorTag (L)"; /* make this (R) or (L) in 3 places HJS */
// "SensorTag 2.0";
...
static const uint8_t devInfoSoftwareRev[] =     "Retrotope";   /* HJS   */
static const uint8_t devInfoSerialNumber[] =     "HINDS (L)";  /* HJS  change 3 places */
...
static void SensorTag_setDeviceInfo(void)
{
  ...
  DevInfo_SetParameter(DEVINFO_SERIAL_NUMBER, sizeof(devInfoSerialNumber),
                       (void*)devInfoSerialNumber);
